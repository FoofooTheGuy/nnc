 ...
 */
void nnc_unswizzle_zorder_le_rgb565_to_rgba8(nnc_u16 *inp, nnc_u32 *outp, nnc_u8 x, nnc_u8 y);
 ...
 *  \param y     Image height, must be aligned by 8.
 */
void nnc_unswizzle_zorder_le_rgb565_to_abgr8(nnc_u16 *inp, nnc_u32 *outp, nnc_u8 x, nnc_u8 y);
 ...
 *  \param y     Image height, must be aligned by 8.
 */
void nnc_swizzle_zorder_rgba8_to_le_rgb565(nnc_u32 *inp, nnc_u16 *outp, nnc_u8 x, nnc_u8 y);
 ...
 *  \param y     Image height, must be aligned by 8.
 */
void nnc_swizzle_zorder_abgr8_to_le_rgb565(nnc_u32 *inp, nnc_u16 *outp, nnc_u8 x, nnc_u8 y);
